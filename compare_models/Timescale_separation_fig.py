...
grid = plt.GridSpec(6,4, wspace=1, hspace=1.1)

# sgro 
ax1 = fig5.add_subplot(grid[0, 0:2])
...
# ax1.set_title('Large time scale seperation',fontsize=title_font_size)


ax2= fig5.add_subplot(grid[1:3, 0:2])
...
ax2.plot(A_trace_orig_smalle[0],R_trace_orig_smalle[0],'o',markersize = 7,color='k')
ax2.plot( A_trace_orig_smalle[-1],R_trace_orig_smalle[-1], 'o',markersize =7,color='k',fillstyle='none')
ax2.set_ylim([-1,2]);
...
ax4.plot(A_trace_orig_bige[0],R_trace_orig_bige[0],'o',markersize = 7,color='k')
ax4.plot( A_trace_orig_bige[-1],R_trace_orig_bige[-1], 'o',markersize =7,color='k',fillstyle='none')
ax4.set_ylim([-1,2]);
...
# Kamino
ax5= fig5.add_subplot(grid[3, 0:2])
...
ax6= fig5.add_subplot(grid[4:, 0:2])
...
ax6.plot( x_trace_smalle[0], y_trace_smalle[0],'o',markersize =7,color='k')
ax6.plot( x_trace_smalle[-1], y_trace_smalle[-1],'o',markersize =7,color='k',fillstyle='none')
...
ax8.plot( x_trace_bige[0], y_trace_bige[0],'o',markersize =7,color='k')
ax8.plot( x_trace_bige[-1], y_trace_bige[-1],'o',markersize =7,color='k',fillstyle='none')
