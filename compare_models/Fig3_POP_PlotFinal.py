...
grid = plt.GridSpec(13, 14, wspace=1.5, hspace=0.9)
...
axA11.set_xlim([0,30]); axA11.set_ylim([-0.25,1.75])
...
axA12.set_xlim([0,30]); axA12.set_ylim([-0.25,1.75])
...
axA13.set_xlim([0,30]); axA13.set_ylim([-0.25,1.75])
...
axA21.set_xlim([0,30]); axA21.set_ylim([0.1,0.9])
...
axA22.set_xlim([0,30]); axA22.set_ylim([0.1,0.9])
...
axA23.set_xlim([0,30]); axA23.set_ylim([0.1,0.9])
...
axA31.set_xlim([0,30]); axA31.set_ylim([-0.2,1.5])
...
axA32.set_xlim([0,30]); axA32.set_ylim([-0.2, 1.5])
...
axA33.set_xlim([0,30]); axA33.set_ylim([-0.2,1.5])
...
axA41.set_xlim([0,30]); axA41.set_ylim([-0.25,1.25])
...
axA42.set_xlim([0,30]); axA42.set_ylim([-0.25,1.25])
...
axA43.set_xlim([0,30]); axA43.set_ylim([-0.25,1.25])
...
axA51.set_xlim([0,30]); axA51.set_ylim([-0.4,1.6])
...
axA52.axvspan(15, 30, alpha=0.2, color='g')
axA52.set_xlim([0,30]); axA52.set_ylim([-0.4,1.6])
...
axA53.set_xlim([0,30]); axA53.set_ylim([-0.4,1.6]) 
