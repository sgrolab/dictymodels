...
# import_npz('../model_outputs/pop_addcAMP_Gregorcorrect_ts0_210831.npz',globals())
import_npz('../model_outputs/Fig8_pop_add_cAMP_gregorTS0_fixrseed_210901.npz',globals())
...
grid = plt.GridSpec(13, 14, wspace=1.6, hspace=0.9)
...
axA02.plot(Sgro2015Figure6excel["Times (min)"],Sgro2015Figure6excel["Intermediate External cAMP Mean Trace"],
                                color = 'k', linewidth=trace_width)
axA02.axvline(x=60, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA02.set_ylim([-0.1,0.6]); axA02.set_xlim([0,120])
axA02.tick_params(grid_linewidth = 15, labelsize = tick_font_size)
axA02.text(0.72,0.82,' Intermediate $cAMP_{e}$\nInput, 10-20nM', horizontalalignment='center',verticalalignment='center',
...
axA02.set_ylabel('FRET, A.U.', size=sublabel_font_size)
...
# Gregor 2010
axA31= fig.add_subplot(grid[0:2,3:6])
...
axA31.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA31.set_xlim([0,30]); axA31.set_ylim([-0.35,1.85])

# axA31.text(-0.06 , 1.2, '(d)', ha='center',va='center',
#          transform = axA31.transAxes, color = simcolor, fontsize=abcd_font_size)
# axA31.set_title('Population Oscillations Slow\nDown Not Replicated in\nPhase Oscillator',color = 'k', size=title_font_size)

axA32= fig.add_subplot(grid[2:4,3:6])
for count in range(5):
...
axA32.text(0.68,0.8,'Intermediate\n'+r'$cAMP_{e}$ Input', ha='center',va='center',
...
axA32.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA32.set_xlim([0,30]); axA32.set_ylim([-0.35,1.85])

axA33= fig.add_subplot(grid[4:6,3:6])
for count in range(5):
...
axA33.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'k')
axA33.set_xlim([0,30]); axA33.set_ylim([-0.35,1.85])

axA31.set_title('Phase Oscillator',color = gregorcolor, size=title_font_size)
axA33.set_xlabel('Time, A.U.', size=sublabel_font_size)
axA32.set_ylabel(r'$cAMP_{i}$, A.U.', size=sublabel_font_size)

# Sgro 2015
axA41= fig.add_subplot(grid[0:2, 6:9])
for count in range(5):
...
axA41.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA41.set_xlim([0,30]); axA41.set_ylim([-0.35,1.85])
...
axA42= fig.add_subplot(grid[2:4, 6:9])
for count in range(5):
...
axA42.text(0.68,0.79,'Intermediate\n'+r'$cAMP_{e}$ Input', ha='center',va='center',
...
axA42.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA42.set_xlim([0,30]); axA42.set_ylim([-0.35,1.85])

axA43= fig.add_subplot(grid[4:6, 6:9])
for count in range(5):
...
axA43.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA43.set_xlim([0,30]); axA43.set_ylim([-0.35,1.85])

axA41.set_title('IPNFB',color = sgrocolor, size=title_font_size)
axA43.set_xlabel('Time, A.U.', size=sublabel_font_size)
axA42.set_ylabel(r'$cAMP_{i}$, A.U.', size=sublabel_font_size)

# Goldbeter 1987
axA11= fig.add_subplot(grid[7:9,0:3])
for count in range(5):
    axA11.plot(t_plot_Goldbeter,b_traces_norm[0,count,:],
              color='darkgrey',alpha=0.5, linewidth=trace_width-1)
axA11.plot(t_plot_Goldbeter,b_traces_norm_mean[0,:], color= goldcolor,linewidth=trace_width)
...
axA11.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA11.set_xlim([0,30]); axA11.set_ylim([-0.35,1.85])

# axA11.text(-0.06 , 1.2, '(b)',
#           horizontalalignment='center',verticalalignment='center',
#           transform = axA11.transAxes, color = simcolor, fontsize=abcd_font_size)
# axA11.set_title('Population Oscillations Slow Down\nDue to Single Cell Spike Height\nDecrease in Receptor Desensitization',color = 'k', size=title_font_size)

axA12= fig.add_subplot(grid[9:11, 0:3])
for count in range(5):
    axA12.plot(t_plot_Goldbeter, b_traces_norm[1,count,:],
              color='darkgrey',alpha=0.5, linewidth=trace_width-1)
axA12.plot(t_plot_Goldbeter, b_traces_norm_mean[1,:], color=goldcolor,linewidth=trace_width)
    

axA12.text(0.68,0.78,'Intermediate\n'+r'$cAMP_{e}$ Input', ha='center',va='center',
...
axA12.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA12.set_xlim([0,30]); axA12.set_ylim([-0.35,1.85])

axA13= fig.add_subplot(grid[11:,0:3])
for count in range(5):
    axA13.plot(t_plot_Goldbeter, b_traces_norm[2,count,:],
              color='darkgrey',alpha=0.5, linewidth=trace_width-1)
axA13.plot(t_plot_Goldbeter, b_traces_norm_mean[2,:], color=goldcolor,linewidth=trace_width)
...
axA13.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA13.set_xlim([0,30]); axA13.set_ylim([-0.35,1.85])

axA11.set_title('Receptor Desensitization',color = goldcolor, size=title_font_size)
axA13.set_xlabel('Time, A.U.', size=sublabel_font_size)
axA12.set_ylabel(r'$cAMP_{i}$, A.U.', size=sublabel_font_size)

# Maeda 2004
axA21= fig.add_subplot(grid[7:9, 3:6])
for count in range(5):
...
axA21.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA21.set_xlim([0,30]); axA21.set_ylim([0,1.05])
...
# axA21.set_title('Population Oscillations Slow Down\nDue to Single Cell Spike Height\nDecrease in CDINFB',color = 'k', size=title_font_size)

axA22= fig.add_subplot(grid[9:11, 3:6])
for count in range(5):
...
axA22.text(0.68,0.78,'Intermediate\n'+r'$cAMP_{e}$ Input', ha='center',va='center',
...
axA22.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA22.set_xlim([0,30]); axA22.set_ylim([0,1.05])

axA23= fig.add_subplot(grid[11:, 3:6])
for count in range(5):
...
axA23.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA23.set_xlim([0,30]); axA23.set_ylim([0,1.05])

axA21.set_title('CDINFB',color = maedacolor, size=title_font_size)
axA23.set_xlabel('Time, A.U.', size=sublabel_font_size)
axA22.set_ylabel(r'$cAMP_{i}$, A.U.', size=sublabel_font_size)
...
axA51.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA51.set_xlim([0,30]); axA51.set_ylim([-0.35,1.85])
...
axA52.text(0.73,0.79,'Intermediate\n'+r'$cAMP_{e}$ Input', ha='center',va='center',
...
axA52.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA52.set_xlim([0,30]); axA52.set_ylim([-0.35,1.85])
...
axA53.axvline(x=15, ls='--', linewidth=trace_width-0.5, color = 'dimgrey')
axA53.set_xlim([0,30]); axA53.set_ylim([-0.35,1.85]) 

axA51.set_title('IFFL',color = kaminocolor, size=title_font_size)
axA53.set_xlabel('Time, A.U.', size=sublabel_font_size)
axA52.set_ylabel(r'$cAMP_{i}$, A.U.', size=sublabel_font_size)

axA13.text(-0.15,1.65, ' ', ha='center',va='center',rotation=90,
          transform = axA13.transAxes, color = 'k', fontsize=label_font_size)
axA13.text(1.75,-0.5, ' ', ha='center',va='center',
          transform = axA13.transAxes, color = 'k', fontsize=label_font_size)
...
# axB0.set_title('Firing Rate Increase\nwith Coupling Strength\nand Dynamics Death\nShown in Experiment', fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
...
axB0.set_ylabel('Cell Density (ML)', size=sublabel_font_size)
...
# axB1lower.set_xlabel('Flow Rate, A.U.', size=sublabel_font_size)
# axB1lower.set_ylabel('Cell Density, A.U.', size=sublabel_font_size)
heatmap.set_clim(0,1.5)
cbar=fig.colorbar(heatmap, ax=axB1lower, ticks=[0,0.5,1,1.5])
cbar.ax.tick_params(labelsize = tick_font_size) 
cbar.set_label( 'Firing Rate, A.U.',size=tick_font_size)
...
# axB2lower.set_xlabel('Flow Rate, A.U.', size=sublabel_font_size)
# axB2lower.set_ylabel('Cell Density, A.U.', size=sublabel_font_size)
...
axB3.set_yscale('log')
# axB3.set_xlabel('Flow Rate, A.U.', size=sublabel_font_size)
# axB3.set_ylabel('Cell Density, A.U.', size=sublabel_font_size)
...
# axB4.set_xlabel('Flow Rate, A.U.', size=sublabel_font_size)
# axB4.set_ylabel('Cell Density, A.U.', size=sublabel_font_size)
...
# axB5lower.set_xlabel('Flow Rate, A.U.', size=sublabel_font_size)
# axB5lower.set_ylabel('Cell Density, A.U.', size=sublabel_font_size)
...
axB5lowerin= fig.add_axes([0.897,0.135,0.046,0.08])
heatmap = axB5lowerin.pcolor(gamma_arr_Kamino, rho_arr_Kamino,
                       pop_rate_Kamino_noise.transpose(), cmap='jet') # cmap='jet'
heatmap.set_clim(0,0.65)
axB5lowerin.set_yscale('log'); axB5lowerin.set_xscale('log');
axB5lowerin.set_xticks([1,10,100]) ; axB5lowerin.set_yticks([1,10,100]) 
axB5lowerin.tick_params( colors='white', grid_color='white',labelsize =9) #, grid_alpha=0.5)
...
fig.text(0.095, 0.93, 'A',fontsize=ABCD_font_size, ha='center')
fig.text(0.633, 0.93, 'B',fontsize=ABCD_font_size, ha='center')
