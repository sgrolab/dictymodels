...
jVals = np.linspace(0,1,26) 
rhoVals = np.logspace(-6,-3,26) 
...
with open('//groups/sgro/sgrolab/mark/dicty_proj/pop_firingRate_data/noise/Sgro/j_%.2i_rho_%.2i.pickle' % (jIndex,rhoIndex),'wb') as f:
