...
function [cell_mask,release_mask,state,X,Y,w,l,x,y]=initial_state(h,firing_ratio)
    ...
    [x,y]=meshgrid(0:h:100*h,0:h:100*h);
    ...
    initial_fig_name=strcat('U:\cilse_research_sgro\Chuqiao\cAMP modeling\Sawai 2005\initial_cond\initial_FR_',num2str(firing_ratio),'xy100.jpg');
