...
#%% load in 2020/3-4 with noise and w/o noise outputs
...
#%% Sgro 2015 from parallel computing outputs
...
# pop_rate_path = OUT_path + r'Sgro_pop_rate.xlsx'
# pop_rate = pd.read_excel(pop_rate_path)
# pop_rate_Sgro_regular_noise=pop_rate.to_numpy()

# rho_arr_Sgro_regular_noise = np.logspace(-5.5,-3,num=26)
# j_arr_Sgro_regular_noise = np.linspace(0,1,num=21)
#%%
...
fig3 = plt.figure(figsize=(30, 9.5))
...
cbar.ax.tick_params(labelsize = tick_font_size) 
ax1.tick_params(axis='both', which='major', labelsize=tick_font_size)
ax1.set_title('Martiel 1987\nwith noise', color=mycolors[0],fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
ax1.text(-0.45 , 1.2, 'B',
         horizontalalignment='center',verticalalignment='center',
...
ax1lower.set_title('Martiel 1987\nw/o noise', color=mycolors[0],fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
...
cbar=fig3.colorbar(heatmap, ax=ax2);cbar.ax.tick_params(labelsize = tick_font_size) 
ax2.tick_params(axis='both', which='major', labelsize=tick_font_size)
ax2.set_title('Maeda 2004\nwith noise', color=mycolors[1],fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
ax2.text(-0.3 , 1.2, 'C',
         horizontalalignment='center',verticalalignment='center',
...
ax2lower.set_title('Maeda 2004\nw/o noise', color=mycolors[1],fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
...
ax3.set_title('Gregor 2010\nwith noise',color=mycolors[2], fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
ax3.text(-0.3 , 1.2, 'D',
         horizontalalignment='center',verticalalignment='center',
...
ax3lower.set_title('Gregor 2010\nw/o noise',color=mycolors[2], fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})

# Sgro regular noise (sig = 0.15)
ax4= fig3.add_subplot(grid[1,3],xticks=[0,0.25,0.5,0.75,1])
...
ax4.set_title('Sgro 2015\nwith noise', color=mycolors[5],fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
ax4.text(-0.3 , 1.2, 'E',
         horizontalalignment='center',verticalalignment='center',
...
ax5.set_title('Kamino 2017\nwith noise', color=mycolors[7], fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
ax5.text(-0.3 , 1.2, 'F',
         horizontalalignment='center',verticalalignment='center',
...
ax5lower.set_title('Kamino 2017\nw/o noise', color=mycolors[7], fontdict={'fontsize': title_font_size, 'fontweight': 'medium'})
...
#%% Plot all models,old, before 2020/4
#abcd_font_size = 28
#title_font_size = 25
#label_font_size = 25
#tick_font_size = 20
