...
for i in range(len(z0First_space_Sgro_noise)):
    ...
    ax[i].set_xticklabels(np.around(FC_space_Sgro_noise,decimals=1),fontsize=tick_font_size)
...
fig.text(0.5, 0.97, 'Sgro 2015 with noise', ha='center', va='center',fontsize=title_font_size,color=mycolors[5],)
fig.text(0.5, 0.02, r'$cAMP_{e}$'+' Fold Change', ha='center', va='center',fontsize=label_font_size)
fig.text(0.08, 0.5, 'Second Spike Prominence, A.U.', ha='center', va='center', rotation='vertical',fontsize=label_font_size)
